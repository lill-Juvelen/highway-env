...
class HighwayEnv(AbstractEnv):
    ...
    def _reward(self, action: Action) -> float:
        ...
        # if target lane is different than the one I'm currently driving there is a lane change
        lane_change = self.vehicle.target_lane_index[2] != self.vehicle.lane_index[2] 
